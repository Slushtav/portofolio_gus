...
export const INITIAL_PROJECT_BUBBLES: Omit<ProjectBubble, 'x' | 'y' | 'vx' | 'vy' | 'isPopping' | 'popProgress'>[] = [
  {
    ...
    category: "profile",
    description: "Welcome to my interactive workspace! I'm Gustav Ananda, a junior fullstack developer on a mission to build scalable applications and high-quality web experiences. Edan inggris gw bagus bet dah. Beberapa tentang diri gw udah dibahas sih di atas.",
  ...
  },
  {
    ...
    category: "project",
    description: "Discover my indie game creations, and jams",
    tags: ["Indie Games", "Big Brainrot", "Game Jams"],
    link: "https://slushtavvmerin.itch.io/",
    color: "#fa5c5c",
  ...
  },
  {
    ...
    link: "https://github.com/Slushtav",
    color: "#0d0c1d",
  ...
  },
  {
    ...
    link: "www.linkedin.com/in/gustav-ananda-2b9778368",
    color: "#1d66b5",
  ...
  },
  {
    ...
    category: "skills",
    description: "Confident Public Speaker, Creative person, Python enthusiam.",
    tags: ["Pejuang Python", "Node.js", "Speaker"],
    color: "#2b9377",
  ...
  },
  {
    ...
    category: "contact",
    description: "Full of surprise, Every year award.",
    tags: ["Social Feed", "Daily Cues", "Developer Vibe"],
    link: "https://www.instagram.com/gs_utap/",
    color: "#c0237c",
  ...
  },
  {
    ...
    category: "project",
    description: "repo Projek ini.",
    tags: ["Pejuang rupiah"],
    link: "https://github.com/Slushtav/portofolio_gus",
    color: "#3d34a5",
  ...
  },
  {
    ...
    link: "https://myanimelist.net/profile/Slushtav",
    color: "#2e51a2",
  ...
  },
  {
    ...
    link: "https://letterboxd.com/Slushtav/",
    color: "#ff8000",
  ...
  },
  {
    ...
    link: "https://backloggd.com/u/Slushtav/",
    color: "#fa1d2f",
